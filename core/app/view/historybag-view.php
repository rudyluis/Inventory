...
$bag = BolsasData::getById($_GET["bag_id"]);
$operations = OperationData::getAllByBagIdAndStock($bag->id_bolsas, $stock->id);
?>
<div class="row">
    <div class="col-md-12">
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="report/history-word.php?id=<?php echo $bag->id;?>&stock_id=<?php echo $_GET["stock"];?>">Word 2007 (.docx)</a></li>
  </ul>
</div>
<h1><?php echo $bag->nombre_bolsas; ?> <small>Historial</small></h1>
<ol class="breadcrumb">
...
<div class="row">
    ...
    <?php
$itotal = OperationData::getInputQByBagStock($bag->id_bolsas, $stock->id);
...
?>
    ...
    <div class="col-md-4">
    <?php
$total = OperationData::getQByBagStock($bag->id_bolsas, $stock->id);
...
?>
    ...
    <?php
$ototal = -1*OperationData::GetOutputQYesF($bag->id_bolsas);
...
<div class="box">
  ...
  <div class="box-body no-padding">
            ...
            $("#oper-"+<?php echo $operation->id; ?>).click(function(){
				...
				if(x==true){
					window.location = "index.php?view=deleteoperation&ref=history&bid=<?php echo $operation->id_bolsa;?>&opid=<?php echo $operation->id;?>&stock=<?php echo $stock->id; ?>";
				}
			});
            </script>
            </tr>
